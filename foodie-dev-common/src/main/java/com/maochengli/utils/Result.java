...
public class Result {
     ...
     * @return
     */
    public static Result error(ExceptionEmum exceptionEmum) {
        Result result = new Result();
        result.setStatus(exceptionEmum.getCode());
        result.setMsg(exceptionEmum.getMsg());
        result.setData(null);
        return result;
    }
